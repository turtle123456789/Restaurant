...
export const testClient = createClient("https://backendrestaurant-0etz.onrender.com/api");

export const client = createClient("https://backendrestaurant-0etz.onrender.com/api");
